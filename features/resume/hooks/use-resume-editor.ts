...
import { AUTOSAVE_TIME_KEY, useResumePersistence } from "@/features/resume/hooks/use-resume-persistence";
...
export function useResumeEditor() {
  ...
  const { createResume, deleteResume, duplicateResume, renameResume, switchResume } = useResumeLibrary({
    state,
    setState,
    importReview,
    setImportReview,
