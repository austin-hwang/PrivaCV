...
function SectionHeading({
  ...
  label: string;
  style: (typeof styles)[ResumeTemplateId];
}) {
  ...
  return (
    <div
      style={{
        borderBottom: `${style.heading === "underline" ? 2 : 4}px solid ${style.accent}`,
        color: style.accent,
        display: "flex",
        fontSize: 17,
        fontWeight: 800,
...
function TextLine({ width = "100%", height = 7 }: { width?: string; height?: number }) {
  return (
    <div style={{ background: "#d9dee7", borderRadius: 10, display: "flex", height, width }} />
  );
}
    ...
    >
      <div
        style={{
          ...
          height: 944,
          padding: style.dense ? "52px 58px" : "62px 66px",
          width: 690,
        }}
      >
        <div
        ...
        >
          ...
          <div style={{ color: "#475569", display: "flex", fontSize: 18, marginTop: 7 }}>
          ...
          >
            Seattle, WA · jordan@example.com · portfolio.example
          </div>
        </div>

        <SectionHeading label="Summary" style={style} />
        <div style={{ display: "flex", flexDirection: "column", gap, marginTop: 15 }}>
          <TextLine />
          <TextLine width="93%" />
          <TextLine width="71%" />
        </div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", marginTop: 17 }}>
          ...
          <div style={{ color: "#64748b", display: "flex", fontFamily: "Arial", fontSize: 13 }}>
            2022 — Present
          </div>
        </div>
        <div style={{ color: "#475569", display: "flex", fontSize: 14, marginTop: 5 }}>
          Northstar Labs
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap, marginTop: 14 }}>
          <TextLine width="96%" />
          <TextLine width="88%" />
          <TextLine width="91%" />
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", marginTop: 21 }}>
          <div style={{ display: "flex", fontSize: 17, fontWeight: 800 }}>Product Designer</div>
          <div style={{ color: "#64748b", display: "flex", fontFamily: "Arial", fontSize: 13 }}>
            2019 — 2022
          </div>
        </div>
        ...
        <div style={{ display: "flex", gap: 14, marginTop: 17 }}>
          <TextLine width="28%" height={10} />
          <TextLine width="21%" height={10} />
          <TextLine width="31%" height={10} />
        </div>
        <div
          style={{
            color: "#64748b",
        ...
        >
          {template.label} · ATS-friendly single-column template
        </div>
      </div>
    </div>,
    {
