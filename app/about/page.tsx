...
const faqItems = [
  {
    ...
    answer:
      "PrivaCV is a browser-based resume editor for creating, tailoring, reviewing, and exporting clean, text-based resumes.",
  },
  {
    question: "Does PrivaCV upload my resume?",
    answer:
      "No. Resume editing, imports, exports, the resume library, and edit history stay in the browser. Optional local AI model files may be downloaded to the browser when a person chooses to prepare a model, but resume text is not sent to an AI service.",
  },
  {
    question: "Is PrivaCV free to use?",
    answer:
      "PrivaCV does not require an account, subscription, or watermark. It provides free PDF export and local DOCX export.",
  },
  {
    question: "Are PrivaCV resumes ATS-friendly?",
    answer:
      "PrivaCV creates clean, text-based resume formats and provides a plain-text review to help people prepare an ATS-friendly resume. Compatibility can still vary by the employer's application system.",
  },
];
...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "Learn how PrivaCV creates clean, ATS-friendly resumes locally in your browser—with no account, subscription, watermark, or resume upload.",
  path: "/about",
  socialImage: "about",
});
      ...
      <main className="mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="mt-12 grid gap-10 text-base leading-relaxed text-muted-foreground md:grid-cols-2">
          <section>
            ...
            <p className="mt-3">
              PrivaCV is for people who want to create a clean resume and organize their job search
              without creating an account or handing personal data to a career platform. It supports
              structured editing, ATS-friendly review, PDF and DOCX export, and a{" "}
              <Link className="underline underline-offset-4" href="/job-application-tracker">
                local job application tracker
              </Link>{" "}
              with resume snapshots and Sankey export.
            </p>
          </section>
          <section>
            ...
            <p className="mt-3">
              Applicant tracking systems vary, so no tool can promise a result with every employer.
              PrivaCV uses straightforward text-based resume structure and lets you inspect the
              exported plain text before applying. That makes it easier to catch missing contact
              information, unclear section titles, and formatting that may not travel well.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <ul className="mt-3 grid list-disc gap-2 pl-5">
              <li>
                Create a resume from a blank draft, sample, imported PDF or DOCX, pasted text, or
                saved JSON.
              </li>
              <li>
                Tailor experience, projects, education, skills, and custom sections for a specific
                application.
              </li>
              <li>
                Review resume checks, compare versions, and export clean PDF, DOCX, or plain-text
                copies.
              </li>
              <li>
                Keep your resume library and per-resume edit history in browser storage under your
                control.
              </li>
              <li>
                <Link className="underline underline-offset-4" href="/job-application-tracker">
                ...
                , next actions, interviews, resume versions, and outcomes in a private local
                pipeline.
              </li>
            </ul>
          </section>
