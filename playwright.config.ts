...
export default defineConfig({
  ...
  fullyParallel: true,
  // GitHub-hosted runners have fewer cores than most development machines.
  // Two browser workers avoid starving Next.js and IndexedDB while still
  // keeping the capability suites parallel.
